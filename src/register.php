<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $_SESSION['customerID'] =  $database->lastInsertId();
...
<body class="register-page login-bg">
    <!-- Navbar -->
                        ...
                        <form class="form" method="POST" action="">
                            <div class="card card-login">
                                ...
                                <div class="card-footer ">
                                    <input value="Register" type="submit" class="btn btn-warning btn-round btn-block mb-3">
                                </div>
                            </div>
                        </form>
                    </div>
